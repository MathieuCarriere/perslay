...
The python function `perslay` takes four arguments:
  ...
  * the fourth argument is a python dictionary containing the parameters of PersLay. This dictionary must have the following keys: 
    ...
    | **name** | **description** |
    | --- | --- |
    | **layer**              | Either "pm", "im", "ls" or "gs". Type of the PersLay layer. "im" is for persistence images, "ls" is for persistence landscapes, "gs" is for the layer implemented in [this article](https://arxiv.org/abs/1707.04041), and "pm" is for the original DeepSet layer, defined in [this article](https://arxiv.org/abs/1703.06114). |
